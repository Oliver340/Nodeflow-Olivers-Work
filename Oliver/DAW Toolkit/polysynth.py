...
def get_sin_oscillator(freq, amp, sample_rate):
    return iter(
            SineOscillator(freq=freq, 
                    amp=amp, sample_rate=sample_rate)
    )
def get_square_oscillator(freq, amp, sample_rate):
    return iter(
            SquareOscillator(freq=freq, 
                    amp=amp, sample_rate=sample_rate)
    )
def get_saw_oscillator(freq, amp, sample_rate):
    return iter(
            SawtoothOscillator(freq=freq, 
                    amp=amp, sample_rate=sample_rate)
    )
def get_triangle_oscillator(freq, amp, sample_rate):
    return iter(
